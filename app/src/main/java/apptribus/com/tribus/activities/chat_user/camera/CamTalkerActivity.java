...
public class CamTalkerActivity extends AppCompatActivity {
    ...
    apptribus.com.tribus.activities.chat_tribu.camera.AutoFitTextureView mTextureView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cam_talker);
        ButterKnife.bind(this);

        mTalkerId = getIntent().getStringExtra(CONTACT_ID);
        mFrom = getIntent().getStringExtra("UserProfileActivity");
    ...
    private void stopRecordingVideo() {
        ...
        Intent mediaUpdateVideo = new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE,
                Uri.fromFile(new File(mVideoFileName)), CamTalkerActivity.this, SendVideoTalkerActivity.class);

        mediaUpdateVideo.putExtra("video_size", fileSize);
        mediaUpdateVideo.putExtra(CONTACT_ID, mTalkerId);
        mediaUpdateVideo.putExtra("cameFrom", "fromCamTalkerActivity");
    ...
    private static class ImageSaver implements Runnable {
        ...
        private void openActivitySendImage(Uri uri, int fileSize, AppCompatActivity mContext) {
            ...
            Intent mediaUpdateImage = new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE,
                    uri, mContext, SendImageTalkerActivity.class);

            mediaUpdateImage.putExtra("image_size", fileSize);
            mediaUpdateImage.putExtra(CONTACT_ID, mTalkerId);
            mediaUpdateImage.putExtra("cameFrom", "fromCamTalkerActivity");
        ...
        public static class ImageSaverBuilder {
            ...
            public synchronized CamTalkerActivity.ImageSaver buildIfComplete() {
                if (!isComplete()) {
                    return null;
                }
                return new CamTalkerActivity.ImageSaver(mImage, mFile, mCaptureResult, mCharacteristics, mContext,
                        mReader);
            }
