...
public class SharingTalkersViewHolder extends RecyclerView.ViewHolder {

    private Context mContext;

    @BindView(R.id.row_sharing_talkers)
    CardView mCardView;
    ...
    public SharingTalkersViewHolder(View itemView) {
        super(itemView);
    ...
    private void setImage(String url){
        ...
        DraweeController dc = Fresco.newDraweeControllerBuilder()
                ...
                .setOldController(mImageTalker.getController())
                .build();
        mImageTalker.setController(dc);
    ...
    public void initSharingTalkersVH(Talk talkerParam, Fragment fragment, String mLink){
        ...
        mReferenceUser
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(talkerUser != null) {
                            setImage(talkerUser.getImageUrl());
                            setTvName(talkerUser.getName());
                            setTvUsername(talkerUser.getUsername());

                            mCardView.setOnClickListener(v -> {
                                openChatTalkerActivity(talkerUser, mLink, fragment);
                            });
                        }
                    }
    ...
    private void openChatTalkerActivity(User talkerUser, String mLink, Fragment fragment) {

        Intent intent = new Intent(fragment.getActivity(), ChatUserActivity.class);
        intent.putExtra(CONTACT_ID, talkerUser.getId());
