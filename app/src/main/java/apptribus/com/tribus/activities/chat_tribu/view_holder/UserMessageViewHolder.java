package apptribus.com.tribus.activities.chat_tribu.view_holder;
...
public class UserMessageViewHolder extends RecyclerView.ViewHolder {
    ...
    //--------------------------------------------- WIDGETS USER LEFT -------------------------------------------------------------
    //text message
    @BindView(R.id.include_layout_text_message_user_left)
    ...
    //voice message
    @BindView(R.id.include_layout_audio_message_user_left)
    ...
    //video message
    @BindView(R.id.include_layout_video_message_user_left)
    ...
    //image message
    @BindView(R.id.include_layout_image_message_user_left)
    ...
    //--------------------------------------------- WIDGETS USER RIGHT -------------------------------------------------------------
    //text message
    @BindView(R.id.include_layout_text_message_user_right_tribu)
    ...
    //voice message
    @BindView(R.id.include_layout_audio_message_user_right_tribu)
    ...
    //video messages
    @BindView(R.id.include_layout_video_message_user_right_tribu)
    ...
    public void setUserNameUserRightVoice(String username, String name) {
        String[] firstName = name.split(" ");
        String appendNameAndUsername = firstName[0] + " (" + username + ")";
    ...
    //set image
    public void setImageUserRightAudioMessage(String url) {
    ...
    // VIDEO MESSAGE
    //set image
    public void setImageUserRightVideoMessage(String url) {
    ...
    public void setUserNameUserRightVideo(String username, String name) {
        String[] firstName = name.split(" ");
        String appendNameAndUsername = firstName[0] + " (" + username + ")";
    ...
    //IMAGE MESSAGE
    //set image
    public void setImageUserRightImageMessage(String url) {
    ...
    public void setUserNameUserRightImage(String username, String name) {
        String[] firstName = name.split(" ");
        String appendNameAndUsername = firstName[0] + " (" + username + ")";
