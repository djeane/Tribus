...
public class ShowVideoPresenter implements View.OnSystemUiVisibilityChangeListener, View.OnClickListener {

    private final ShowVideoView view;
    private final ShowVideoModel model;
    ...
    public ShowVideoPresenter(ShowVideoView view, ShowVideoModel model) {
        this.view = view;
        this.model = model;
    }
