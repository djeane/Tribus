...
public class SendVideoTalkerPresenter implements View.OnClickListener{

    private final SendVideoTalkerView view;
    private final SendVideoTalkerModel model;
    ...
    public SendVideoTalkerPresenter(SendVideoTalkerView view, SendVideoTalkerModel model) {
        this.view = view;
        this.model = model;
    }
...
/*        MediaSource mediaSource = new HlsMediaSource(Uri.parse("https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8"),
    ...
    private Subscription observeBtnSendVideo(){
        return view.observeBtnSendVideo()
                ...
                .doOnNext(user -> {
                    if (user != null){
                        model.uploadVideoToFirebase(user, view.mUri, description,
                                view.mTotalDuration.getText().toString().trim(), view.mFileSize);
                    }
                })
                .subscribe();
    };
