package apptribus.com.tribus.activities.invitations_request_user.adapter;
...
public class InvitationRequestUserAdapter extends RecyclerView.Adapter<InvitationRequestUserAdapter.InvitationRequestUserViewHolder> {

    private Context mContext;
    private List<Talk> mListContacts;
    private InvitationRequestUserView mView;
    private InvitationRequestUserListener mListener;


    public InvitationRequestUserAdapter(Context context, List<Talk> listContacts, InvitationRequestUserView view,
    ...
    @NonNull
    @Override
    public InvitationRequestUserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_invitation_request_user, parent, false);

        return new InvitationRequestUserViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull InvitationRequestUserViewHolder holder, int position) {

        Talk contact = mListContacts.get(position);

        holder.initInvitationRequestUserViewHolder(contact);
    }
    ...
    public class InvitationRequestUserViewHolder extends RecyclerView.ViewHolder {
        ...
        public InvitationRequestUserViewHolder(View itemView) {
            super(itemView);
        ...
        private void initInvitationRequestUserViewHolder(Talk contact) {
                        ...
                        mTribusCollection
                                ...
                                .addOnSuccessListener(documentSnapshotTribu -> {
                                    ...
                                    mTvUsernameUserInvited.setOnClickListener(v -> {
                                        mListener.openUserProfile(userContact.getId(), contact.getTribuKey());
                                    });
    ...
    public interface InvitationRequestUserListener {
        ...
        void openUserProfile(String userContactId, String tribuKey);
    }
