package apptribus.com.tribus.activities.profile_tribu_follower.adapter;
...
public class ProfileTribuFollowerAdapter extends RecyclerView.Adapter<ProfileTribuFollowerAdapter.ProfileTribuAdminViewHolder> {

    private Context mContext;
    private List<Follower> mListFollowers;
    private String mTribusKey;
    private ProfileTribuFollowerAdapterListener mListener;

    public ProfileTribuFollowerAdapter(Context context, List<Follower> listFollowers, String tribusKey,
    ...
    public interface ProfileTribuFollowerAdapterListener {
