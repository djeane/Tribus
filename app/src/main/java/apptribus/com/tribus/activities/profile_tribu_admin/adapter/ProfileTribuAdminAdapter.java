package apptribus.com.tribus.activities.profile_tribu_admin.adapter;
...
public class ProfileTribuAdminAdapter extends RecyclerView.Adapter<ProfileTribuAdminAdapter.ProfileTribuAdminViewHolder> {

    private Context mContext;
    private List<Follower> mListFollowers;
    private String mTribusKey;
    private ProfileTribuAdminAdapterListener mListener;

    public ProfileTribuAdminAdapter(Context context, List<Follower> listFollowers, String tribusKey,
    ...
    public interface ProfileTribuAdminAdapterListener {
